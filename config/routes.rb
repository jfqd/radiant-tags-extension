ActionController::Routing::Routes.draw do |map|
  ...
  begin
    ...
    elsif defined?(Globalize2Extension)
      map.connect "/:locale#{Radiant::Config['tags.results_page_url']}/:tag/", :controller => 'site', :action => 'show_page', :url => Radiant::Config['tags.results_page_url']
    end
